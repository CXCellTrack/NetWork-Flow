...
set trainSegPath=E:\datasets\first_edition\training_datasets\N2DH-GOWT1\02_0-64_seg

reg add "%regpath%" /v %evname% /d %trainSegPath% /f

set evname=trainTrackPath

set trainTrackPath=E:\datasets\first_edition\training_datasets\N2DH-GOWT1\02_0-64_track
...
set testSegPath=E:\datasets\first_edition\training_datasets\N2DH-GOWT1\01_0-64_seg

reg add "%regpath%" /v %evname% /d %testSegPath% /f

set evname=testTrackPath

set testTrackPath=E:\datasets\first_edition\training_datasets\N2DH-GOWT1\01_0-64_track
