...
set trainTrackPath=E:\datasets\second_edition\training_datasets\Fluo-N2DH-SIM+\01_4-16_track\超像素
...
set testTrackPath=E:\datasets\second_edition\competition_datasets\Fluo-N2DH-SIM+\01_4-16_track\超像素
